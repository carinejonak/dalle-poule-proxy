export default async function handler(req, res) {
  ...
  const prompt = `A vintage naturalist illustration of a french ${breedCapitalized} hen, realistic feathers and anatomy, elegant profile pose, intricate feather texture, small red comb, NO TEXT at all, no watermark, pure white background #FFFFFF, 19th-century ornithological art style.`;
